...
async def help(ctx):
	...
	embed.add_field(name="math", value="x!math add (number) (number)")
	embed.add_field(name="math", value="x!math subtract (number) (number)")
	embed.add_field(name="math", value="x!math multiply (number) (number)")
	embed.add_field(name="math", value="x!math divide (number) (number)")
	embed.add_field(name="addrole", value="x!addrole @mention (role name)")
	embed.add_field(name="removerole", value="x!removerole @mention (role name)")
	embed.add_field(name="clean", value="x!clean (amount of message)")
	embed.add_field(name="userinfo", value="x!userinfo @mention")
